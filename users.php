...
if ($action == "delete") {
	...
	if (!$haserror) {
		...
		mail(
			$email,
			"Scovetta XMAS Registry - Account Created",
			"Your account has been successfully created on the Scovetta XMAS Registry.\r\n" . 
            "  Username: '$username'\r\n" .
            "  Password: '$pwd'\r\n" .
            "\r\n" .
            "You can access the Scovetta XMAS Registry at:\r\n" .
            "  http://www.scovetta.com/xmas\r\n", 
	...
	mail(
		$resetemail,
			"Scovetta XMAS Registry - Account Created",
		"Your account password has been reset on the Scovetta XMAS Registry.\r\n" .
        "  Password: $pwd\r\n" .
        "\r\n" .
        "You can access the Scovetta XMAS Registry at:\r\n" .
        "  http://www.scovetta.com/xmas\r\n", 
